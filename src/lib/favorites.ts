...
export const HISTORICAL: FavoriteRef[] = [
  ...
  { artist: 'Gustav Klimt', source: 'wikipedia', page: 'The Three Ages of Woman (Klimt)', title: 'The Three Ages of Woman', date: '1905', note: 'Olivia chose the Mother and Child detail; pin the Commons crop (direct URL) once verifiable' },
  { artist: 'Pierre-Auguste Cot', source: 'met', query: 'The Storm' },
  { artist: 'Caspar David Friedrich', source: 'met', query: 'Two Men Contemplating the Moon', note: 'Placeholder — Olivia deciding among Reefs by the Seashore / Ruins of the Oybin / Coastal Landscape with Cross and Statue (all Wikimedia, likely need direct URLs)' },
